...
import (
  ...
  "github.com/cyprusteam/swagger/markup"
  "github.com/cyprusteam/swagger/parser"
)
...
func generateSwaggerDocs(parser *parser.Parser, outputSpec string) error {
  ...
  doc = strings.Replace(doc, "{{packageName}}", parser.PackageName, -1)
...
type Params struct {
  ApiPackage, MainApiFile, OutputFormat, OutputSpec, ControllerClass, PackageName string
}

func Run(params Params) error {
  parser := InitParser(params.ControllerClass)
  parser.PackageName = params.PackageName
